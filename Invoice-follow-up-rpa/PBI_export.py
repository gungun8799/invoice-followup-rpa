...
class PowerBIExportAutomation:
    ...
    async def wait_for_report(self):
        ...
        # Don't wait for specific elements, just give the page time to load
    ...
    async def export_report(self):
        ...
        try:
            ...
            print(f"⚠️ Report block click failed: {e}")
            # Continue anyway
        ...
        await self.page.wait_for_timeout(5000)  # Wait for dialog
    ...
    async def handle_download(self):
        ...
        async with self.page.expect_download() as download_info:
            ...
            await self.page.wait_for_timeout(30000)  # Wait up to 30 seconds
    ...
    async def run(self):
        ...
        try:
            print("="*50)
            print("🤖 Power BI Export Automation")
            print("="*50)
